...
hidden if the `network-exercises_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `network-exercises_DEVELOPER_MODE` to the configure
