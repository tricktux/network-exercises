...
#define PRIME_RESPONSE_ILLFORMED "{\"method\":\"isPrime\",\"prime\":ill-formed-request!}"
...
int is_prime_request_builder(struct is_prime_request **request, const char* raw_request, size_t req_size);
